...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t port0_pin28_config = {/* Internal pull-up resistor is enabled */
    												kPORT_PullDisable,
        ...
        /* PORT0_28 is configured as GPIO*/
        PORT_SetPinConfig(PORT0, 28U, &port0_pin28_config);

        const port_pin_config_t port3_pin15_config = {/* Internal pull-up resistor is enabled */
        												kPORT_PullDisable,
        		                                       /* Low internal pull resistor value is selected. */
        		                                       kPORT_LowPullResistor,
        		                                       /* Fast slew rate is configured */
        		                                       ...
        		                                       /* Pin Control Register fields [15:0] are not locked */
        		                                       kPORT_UnlockRegister};
            /* PORT3_15 is configured as GPIO */
        PORT_SetPinConfig(PORT3, 15U, &port3_pin15_config);
